...
class BoostingExperiment(experiments.BaseExperiment):
    ...
    def perform(self):
        ...
        if self._details.ds_name == 'bank_marketing':
            best_params = {'base_estimator__max_depth': 10, 'learning_rate': 0.32, 'n_estimators': 30}
        elif self._details.ds_name == 'adult_salary':
            best_params = {'base_estimator__max_depth': 10, 'learning_rate': 0.08, 'n_estimators': 60}
        # Dataset 1:
