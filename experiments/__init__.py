...
def basic_results(clf, classes, training_x, training_y, test_x, test_y, params, complexity_param, clf_type=None, dataset=None,
    ...
    if best_params:
        ...
        plt.savefig('{}/images/{}_{}_NCM.png'.format(OUTPUT_DIRECTORY, clf_type, dataset), format='png', dpi=150,
                    bbox_inches='tight')
        print('CLF={}, dataset={}, test_score={}'.format(clf_type, dataset_readable_name, test_score))
        cv = clf
    else:
        ...
        cv = ms.GridSearchCV(clf, n_jobs=threads, param_grid=params, verbose=10, cv=5, scoring=curr_scorer)
...
def perform_experiment(ds, ds_name, ds_readable_name, clf, clf_name, clf_label, params, timing_params=None,
    ...
    if not iteration_lc_only:
        ds_clf = basic_results(pipe, np.unique(ds.classes), ds_training_x, ds_training_y, ds_testing_x, ds_testing_y,
                               params, complexity_param, clf_name, ds_name, ds_readable_name, balanced_dataset=ds.balanced,
